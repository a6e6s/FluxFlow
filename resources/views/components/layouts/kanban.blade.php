    ...
    <header
        ...
        <div class="flex items-center gap-4">
            <div class="flex items-center gap-2">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" x-transition @click.away="open = false"
                        class="absolute top-full mt-2 w-36 ltr:right-0 rtl:left-0 bg-white dark:bg-[#1c2630] border border-slate-200 dark:border-[#283239] rounded-lg shadow-xl z-50 py-1">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" x-transition @click.away="open = false"
                    class="absolute top-full mt-2 w-64 max-w-[calc(100vw-2rem)] ltr:right-0 rtl:left-0 bg-[#1c2630] border border-[#283239] rounded-lg shadow-xl z-50 py-2">
                    {{-- User Info --}}
